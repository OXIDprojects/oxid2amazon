...
[{* ### oxid2amazon BEGIN ### *}]
          <tr>
            <td class="edittext">
              [{ oxmultilang ident="AZ_AMZ_ARTICLE_SHIP_OPTION" }]
            </td>
            <td class="edittext">
              <input type="text" class="editinput" size="25" maxlength="[{$edit->oxarticles__az_amz_ship_option->fldmax_length}]" name="editval[oxarticles__az_amz_ship_option]" value="[{$edit->oxarticles__az_amz_ship_option->value}]"  [{ $readonly }]>
            </td>
          </tr>
          <tr>
            <td class="edittext">
              [{ oxmultilang ident="AZ_AMZ_ARTICLE_SHIP_TYPE" }]
            </td>
            <td class="edittext">
            <select class="editinput" name="editval[oxarticles__az_amz_ship_type]" [{ $readonly }]>
                <option value=""[{if $edit->oxarticles__az_amz_ship_type->value eq ''}] selected="selected"[{/if}]>-</option>
                <option value="Additive"[{if $edit->oxarticles__az_amz_ship_type->value eq 'Additive'}] selected="selected"[{/if}]>[{ oxmultilang ident="AZ_AMZ_ARTICLE_SHIP_TYPE_ADDITIVE" }]</option>
                <option value="Exclusive"[{if $edit->oxarticles__az_amz_ship_type->value eq 'Exclusive'}] selected="selected"[{/if}]>[{ oxmultilang ident="AZ_AMZ_ARTICLE_SHIP_TYPE_EXCLUSIVE" }]</option>
            </select>
            </td>
          </tr>
          <tr>
            <td class="edittext">
              [{ oxmultilang ident="AZ_AMZ_ARTICLE_SHIP_AMOUNT" }]
            </td>
            <td class="edittext">
              <input type="text" class="editinput" size="25" maxlength="[{$edit->oxarticles__az_amz_ship_amount->fldmax_length}]" name="editval[oxarticles__az_amz_ship_amount]" value="[{$edit->oxarticles__az_amz_ship_amount->value}]" [{ $readonly }]>
            </td>
          </tr>
[{* ### oxid2amazon END ### *}]           
