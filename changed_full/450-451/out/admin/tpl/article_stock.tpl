...
[{* ### oxid2amazon BEGIN ### *}]
              <td class="edittext">
                  [{ oxmultilang ident="AZ_AMZ_ARTICLE_STOCK_RESERVE" }]
                </td>
                <td class="edittext">
                  <input type="text" class="editinput" size="20" maxlength="[{$edit->oxarticles__az_amz_stock_reserve->fldmax_length}]" name="editval[oxarticles__az_amz_stock_reserve]" value="[{$edit->oxarticles__az_amz_stock_reserve->value}]" [{include file="help.tpl" helpid=article_stock}] [{ $readonly }]>
                </td>
              </tr>
[{* ### oxid2amazon END ### *}]      
